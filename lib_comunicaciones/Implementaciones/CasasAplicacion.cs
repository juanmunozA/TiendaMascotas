...
{
    public class CasasAplicacion : ICasasAplicacion
    {
        private ICasasRepositorio? iRepositorio = null;

        public CasasAplicacion(ICasasRepositorio iRepositorio)
        {
        ...
        public List<Casas> Buscar(Casas entidad, string tipo)
        {
            Expression<Func<Casas, bool>>? condiciones = null;
            switch (tipo.ToUpper())
            {
